...
const Footer: FunctionComponent<FooterProps> = () => {
  return (
    <footer className="flex justify-between max-xl:flex-col max-xl:items-center max-xl:gap-8 bg-very-dark-violet-neutral px-24 py-16">
      <div>
      ...
      <div className="flex max-md:flex-col max-md:gap-10 max-md:text-center gap-20">
        <div className="flex flex-col gap-4">
          <h4 className="text-white">Features</h4>
          <ul className="flex flex-col gap-1">
            <li className="hover:text-cyan-primary cursor-pointer transition-colors duration-300">
              Link Shortening
            </li>
            <li className="hover:text-cyan-primary cursor-pointer transition-colors duration-300">
              Branded Links
        ...
        <div className="flex gap-4 items-baseline">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
            <path
              className="fill-white hover:fill-cyan-primary cursor-pointer transition-colors duration-300"
